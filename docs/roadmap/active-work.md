...
- The second Codex invocation in the active Node lifecycle is the `generate` stage after `plan`, not a failed retry. Its current source replaces the planning-stage tree; review only the final candidate.
