...
The default named workflow selected when a Component does not point at a different
one. This workflow defines the ordered model and guarded lifecycle stages.
